...
const translations: Record<Language, { ui: Record<string, string>, pages: Record<PortalPage, PageGuidance> }> = {
  en: {
    ...
    pages: {
      ...
      'care-path': { message: 'Choose the care approach that feels right for you today. Both paths are private and guided.', next: 'Select Allopathic or Ayurvedic care to continue.', steps: [{ target: '#care-path-options', title: 'Choose your care path', message: 'Select Allopathic or Ayurvedic care. Veda will tailor the questions to your choice.' }] },
  ...
  hi: {
    ...
    pages: {
      ...
      'care-path': { message: 'आज आपके लिए सही लगने वाला देखभाल दृष्टिकोण चुनें।', next: 'जारी रखने के लिए एलोपैथिक या आयुर्वेदिक देखभाल चुनें।', steps: [{ target: '#care-path-options', title: 'अपना मार्ग चुनें', message: 'एलोपैथिक या आयुर्वेदिक चुनें। वेदा आपके चुनाव के अनुसार सवाल पूछेगी।' }] },
  ...
  mr: {
    ...
    pages: {
      ...
      'care-path': { message: 'आज तुम्हाला योग्य वाटेल तो काळजीचा मार्ग निवडा.', next: 'पुढे जाण्यासाठी ॲलोपॅथिक किंवा आयुर्वेदिक काळजी निवडा.', steps: [{ target: '#care-path-options', title: 'तुमचा मार्ग निवडा', message: 'ॲलोपॅथिक किंवा आयुर्वेदिक निवडा. वेदा तुमच्या निवडीनुसार प्रश्न विचारेल.' }] },
